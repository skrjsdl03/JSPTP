...
<div class="order-container">
  ...
  <div class="order-content">
    ...
    <!-- 상단 선택/삭제 -->
    <div class="order-row" style="justify-content: space-between; border-bottom: 1px solid #ddd;">
    ...
    <div class="order-row">
      ...
      <div class="order-meta">
        <p style="text-align: right;">
          ...
          <br>
          <a href="#" style="font-size: 13px;">옵션 변경</a>
          <br>
    ...
    <div style="width: 100%; display: flex; justify-content: center; margin-top: 40px;">
      <button style="background: black; color: white; border: none; padding: 12px 40px; font-size: 14px; border-radius: 6px; cursor: pointer;">주문하기</button>
    </div>
  </div>
</div>
